...
- Publish via npm Trusted Publisher OIDC instead of a long-lived
  `NPM_TOKEN`. No code changes; release plumbing only.
- Docs: rewrote landing-page tagline; tightened hero padding; opted the
  PR review bot into manual-trigger-only.
